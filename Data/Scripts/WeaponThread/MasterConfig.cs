namespace WeaponThread
{
    partial class Weapons
    {
        internal Weapons()
        {
            ...
            ConfigFiles(PDCgatling, RetractRightPDCgatling, RetractLeftPDCgatling, RetractTopPDCgatling, RetractRightPDCgatlingSB, RetractLeftPDCgatlingSB, RetractTopPDCgatlingSB);
        }
    }
}
