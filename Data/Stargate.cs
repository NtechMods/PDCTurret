...
namespace Phoenix.Stargate
{
    ...
    public class Stargate : SerializableBlock
    {
        ...
        static void CreateTerminalControls()
        {
            ...
            var dialButton = MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlButton, IMyReactor>(dialname);
            ...
            MyAPIGateway.TerminalControls.AddAction<IMyReactor>(dialAction);

            // Iris Control
            var irisName = "Phoenix.Stargate.Iris";
            var irisOnOff = MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlOnOffSwitch, IMyReactor>(irisName);
            ...
            MyAPIGateway.TerminalControls.AddControl<IMyReactor>(irisOnOff);

            // Iris Action
            IMyTerminalAction irisAction = MyAPIGateway.TerminalControls.CreateAction<IMyReactor>(irisName);
            ...
            MyAPIGateway.TerminalControls.AddAction<IMyReactor>(irisAction);

            // On
            actionname = new StringBuilder();
            actionname.Append(irisOnOff.Title).Append(" ").Append(irisOnOff.OnText);

            irisAction = MyAPIGateway.TerminalControls.CreateAction<IMyReactor>(irisName + "_On");
            ...
            irisAction = MyAPIGateway.TerminalControls.CreateAction<IMyReactor>(irisName + "_Off");
            ...
            var resetButton = MyAPIGateway.TerminalControls.CreateControl<IMyTerminalControlButton, IMyReactor>(resetName);
            ...
            MyAPIGateway.TerminalControls.AddControl<IMyReactor>(resetButton);

            // Reset Action
            IMyTerminalAction resetAction = MyAPIGateway.TerminalControls.CreateAction<IMyReactor>(resetName);
            ...
            MyAPIGateway.TerminalControls.AddAction<IMyReactor>(resetAction);

            // Destination PB property
            var destination = "Phoenix." + Globals.ModName + ".Destination";
            var destProperty = MyAPIGateway.TerminalControls.CreateProperty<string, IMyReactor>(destination);
            ...
            MyAPIGateway.TerminalControls.AddControl<IMyReactor>(destProperty);

            // Status PB property
            var statusname = "Phoenix." + Globals.ModName + ".Status";
            var statusProp = MyAPIGateway.TerminalControls.CreateProperty<string, IMyReactor>(statusname);
            ...
            MyAPIGateway.TerminalControls.AddControl<IMyReactor>(statusProp);
        }
        ...
        public void DialChevron(Chevron chevron = Chevron.None)
        {
            ...
            if (m_dhd != null && !m_dhd.BlockDefinition.SubtypeName.Contains("Computer"))
                fastDialDest = true;
                        ...
                        try
                        {
                            if (Data.IsRemote || RemoteGate.IsIrisActive())
                            {
                                ...
                                else
                                {
                                    ...
                                    if (m_movedEntities.Where(e => e.Entity.EntityId == entity.EntityId && e.Expires > DateTime.Now).Count() > 0)
                                        continue;
